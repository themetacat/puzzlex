...
library TotalSupply {
   ...
   */
  function getTotalSupply(address tokenAddr) internal view returns (uint256 totalSupply) {
   ...
   * @notice Get totalSupply.
   */
  function _getTotalSupply(address tokenAddr) internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Get totalSupply.
   */
  function get(address tokenAddr) internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Get totalSupply.
   */
  function _get(address tokenAddr) internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   */
  function setTotalSupply(address tokenAddr, uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Set totalSupply.
   */
  function _setTotalSupply(address tokenAddr, uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Set totalSupply.
   */
  function set(address tokenAddr, uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Set totalSupply.
   */
  function _set(address tokenAddr, uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   */
  function deleteRecord(address tokenAddr) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   * @notice Delete all data for given keys.
   */
  function _deleteRecord(address tokenAddr) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
   ...
   */
  function encodeKeyTuple(address tokenAddr) internal pure returns (bytes32[] memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
