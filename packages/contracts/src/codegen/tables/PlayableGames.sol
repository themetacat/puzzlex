...
library PlayableGames {
   ...
   * @notice Get times.
   */
  function getTimes(address tokenAddr, uint256 tokenId, address buyer) internal view returns (uint256 times) {
   ...
   * @notice Get times.
   */
  function _getTimes(address tokenAddr, uint256 tokenId, address buyer) internal view returns (uint256 times) {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
    _keyTuple[1] = bytes32(uint256(tokenId));
    _keyTuple[2] = bytes32(uint256(uint160(buyer)));
   ...
   * @notice Set times.
   */
  function _setTimes(address tokenAddr, uint256 tokenId, address buyer, uint256 times) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
    _keyTuple[1] = bytes32(uint256(tokenId));
    _keyTuple[2] = bytes32(uint256(uint160(buyer)));
   ...
   */
  function deleteRecord(address tokenAddr, uint256 tokenId, address buyer) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
    _keyTuple[1] = bytes32(uint256(tokenId));
    _keyTuple[2] = bytes32(uint256(uint160(buyer)));
   ...
   * @notice Delete all data for given keys.
   */
  function _deleteRecord(address tokenAddr, uint256 tokenId, address buyer) internal {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
    _keyTuple[1] = bytes32(uint256(tokenId));
    _keyTuple[2] = bytes32(uint256(uint160(buyer)));
   ...
   */
  function encodeKeyTuple(address tokenAddr, uint256 tokenId, address buyer) internal pure returns (bytes32[] memory) {
    bytes32[] memory _keyTuple = new bytes32[](3);
    _keyTuple[0] = bytes32(uint256(uint160(tokenAddr)));
    _keyTuple[1] = bytes32(uint256(tokenId));
    _keyTuple[2] = bytes32(uint256(uint160(buyer)));
